...
from exceptions import TokenNotFound, NoResultFound
...
def add_token_to_database(encoded_token, identity_claim):
    ...
    app.logger.debug('DB Token', db_token)
...
def revoke_user_tokens(user_identity):
    """
    ...
    try:
        ...
        raise TokenNotFound("Could not find a token.")
